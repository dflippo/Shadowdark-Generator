...
- **The Reality:** The party can inspect it.
  - _DC 12 INT (Investigation):_ It’s hollow. There is a hatch in the belly, but
    inside... nothing. No cultists. No bombs. Just empty space and the smell of
    sawdust.
  - _Insight:_ It looks like it was _meant_ to hold something, or be pushed
    somewhere. But why leave it here?

**The Dominion's Solution:** Since it’s not attacking them, the Quartermaster
tags it: _"Property of the Crown: One (1) Idol, Rabbit, Wooden."_ They order it
...
1.  **Carousing (Socializing with the Officers):** _Cost: 10gp._
    ...
    - _Failure:_ You offend a Lieutenant.
2.  **Research (The Star Map):** _Cost: 50gp (Bribing archivists)._
    - _Result:_ Uncover legends of the "Sky-Callers" who used the ziggurats to
      speak to the stars.
3.  **Training/Fortifying:**
    - Helping Durgan upgrade the defenses or training with the soldiers.
...
The climax of the session is a formal dinner hosted by **Colonel Huzzard** in
...
- **Colonel Huzzard:** Large, ruddy-faced, wears a monocle. Believes the jungle
...
- **The Problem:** The engineers came back... wrong. Babbling about "The space
  between the stars" and "The eyes in the dark." Two are catatonic. One tried to
  eat his own boots.
- **The Request:** "My men are soldiers, not... whatever _you_ are. Exorcists?
  Tomb robbers? I need you to go in. Clear it out. Confirm it's safe for
  demolition."
...
- **Description:** The mossy remnants of ancient marble pillars stand at
  ...
  swirls and patterns on a few.
- **Secret:** _DC 14 WIS (Perception)_ or investigating the patterns. One pillar
  has a subtle secret door in its base.
- **Loot:** Inside acts a velvet bag holding an **Amulet of Secrecy**
  (Shadowdark Item).
- **Blackwood:** "Building code violations everywhere. Typical savage
  architecture."
...
- **Encounter:** The tree is **Maied**, a sweet old treant auntie.
  ...
  - _The Puzzle Key:_ woven into her vines are **Heavy Brass Cogs** (Essential
    for Area 8).
  - _Negotiation:_ She won't part with them unless given "equally beautiful
    replacements." (Shiny gems, art objects, or a very good Performance check).
- **Blackwood:** Reaches for his heavy crossbow. "Timber! It's a monster!" _The
  party must stop him or Maied will crush him._

**3. Hall of Paintings**

- **Description:** Heavily peeling frescoes cover the walls.
  - _Image 1:_ A citadel of rich green and red stone in the jungle (**The Lost
    City of Zuchotl**, Hex 92-I).
  - _Image 2:_ Indistinct, purplish shapes lifting and devouring white-clad
    human warriors.
  - _Insight:_ PCs familiar with the jungle recognize the silhouette of
...
- **Encounter:** Two **Mated Panthers** lurk in the shadows (DC 12 WIS to
  notice).
...
- **Description:** Three broad, connected wheels of bright copper. Patterns of
  ...
  _"Map of the heavens, guide our eyes and hearts."_
- **Effect:** Touching the wheel while the North Star is visible (Night) grants
  1 XP.
- **Relevance:** This is the **Star Map**. Rubbing graphite or ink on paper over
  these wheels produces the chart the Army needs.

**4. Moon Wheels**

- **Description:** Two giant, interlocking wheels of untarnished silver. Phases
  of the moon are etched into its surface. _"Ever-changing, ever-knowing. Silver
  light protect us."_
- **Effect:** Touching it during a Full Moon grants ADV on next spellcasting
  check.

**5. Sun Wheels**

- **Description:** A pair of enormous, toothed wheels of gleaming gold. _"Foe of
  the dark ones, banisher of evil."_
- **Effect:** Touching it at Zenith (Noon) grants a Luck Token.

**8. Broken Eclipse Wheel (The Danger)**

- **Description:** A single, cracked wheel of obsidian. Its etchings show a disc
  moving across the sun by blotting it out. It is stuck on a day marking an
...
- **The Choice:**
  ...
  2.  **Fix it:** Inserting the cogs allows it to turn.
      - _Effect:_ Fixing it aligns the prophecy. It reveals the location of the
        **Temple of the Eclipse** (The Cult's true base).
      - _Risk:_ Touching it during an eclipse grants 1d8 Temp HP, but fixing it
