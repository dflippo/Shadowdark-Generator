...
- [NPCs Directory](River%20of%20Night/npcs/README.md)
...
- Large binary files (use `shadowdark-library/` for extracted content instead) `shadowdark-library/` folder for local copies you keep off
...
See [npcs/README.md](River%20of%20Night/npcs/README.md) for the full NPC directory and relationship map.
...
- Use the `*_GUIDE.md` files in `shadowdark-library/` to document where to obtain commercial content legallywn
[[Session 01 - The House on Mivvin's Rest]]
[[Session 02 - The Proving Ground]]
```
