...
- **.agent/**: Contains the agent skills, configuration files, and scripts that
...
**Documentation**:
[.agent/skills/pdf-reader/SKILL.md](.agent/skills/pdf-reader/SKILL.md)
...
**Documentation**:
[.agent/skills/skills-main/README.md](.agent/skills/skills-main/README.md)
